...
# setup io file names
inFile = "~/data/babysleep/web_dumps/webform_views_baby_info20170803120025.csv"
...
baby_info_table = pd.read_csv(inFile, header=0, names=hdr,error_bad_lines=False,quotechar='\'',encoding="ISO-8859-1")
...
# setup io file names
inFile = "~/data/babysleep/web_dumps/webform_views_biological_sibling_info20170803120025.csv"
...
sibling_info_table = pd.read_csv(inFile, header=0, names=hdr,error_bad_lines=False,quotechar='\'',encoding="ISO-8859-1")
...
# setup io file names
inFile = "~/data/babysleep/web_dumps/webform_views_child_diagnosis20170803120033.csv"
...
# setup io file names
inFile = "~/data/babysleep/web_dumps/webform_views_register_your_baby_for_the_research_study20170803120022.csv"
...
register_info_data = pd.read_csv(inFile, header=0, names=hdr,error_bad_lines=False,quotechar='\'',encoding="ISO-8859-1")
...
# setup io file names
inFile = "~/data/babysleep/web_dumps/webform_views_parent_info20170803120033.csv"
...
parent_info_data = pd.read_csv(inFile, header=0, names=hdr,error_bad_lines=False,quotechar='\'',encoding="ISO-8859-1")
...
# setup io file names
inFile = "~/data/babysleep/web_dumps/webform_views_family_info20170803120026.csv"
...
family_info_data = pd.read_csv(inFile, header=0, names=hdr,error_bad_lines=False,quotechar='\'',encoding="ISO-8859-1")
...
inFile = "clean_all_fix201709.csv"
...
#r=[]
#r = pd.DataFrame(r)
#r['kidID'] = register_info_table.kID
#r['DOB'] = register_info_table.DOB
#data=pd.merge(data, r, on='kidID', how='outer')
#data.DOB = pd.to_datetime(data.DOB, errors='coerce')
#tdiff = data.startTime-data.DOB
#data['daysOld'] = tdiff.dt.days
#data['weeksOld'] = np.floor(data.daysOld/7)
...
# Testing to fix import error
nursing_table = nursing_table.drop('extraData',axis=1)
nursing_table = nursing_table.drop('text',axis=1)
nursing_table = nursing_table.drop('notes',axis=1)
nursing_table = nursing_table.drop('caregiver',axis=1)
nursing_table = nursing_table.drop('childName',axis=1)
